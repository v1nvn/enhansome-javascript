...
* [Bower](https://github.com/bower/bower) ⭐ 14,938 | 🐛 14 | 🌐 JavaScript | 📅 2024-10-13 - A package manager for the web.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,945 | 🐛 212 | 🌐 JavaScript | 📅 2026-02-08 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,040 | 🐛 585 | 🌐 JavaScript | 📅 2026-02-04 - Blazing fast, zero configuration web application bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 41,758 | 🐛 239 | 🌐 TypeScript | 📅 2026-02-08 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,689 | 🐛 239 | 🌐 TypeScript | 📅 2026-02-07 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,283 | 🐛 237 | 🌐 TypeScript | 📅 2026-02-05 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,874 | 🐛 225 | 🌐 JavaScript | 📅 2026-02-07 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
...
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,301 | 🐛 178 | 🌐 JavaScript | 📅 2026-01-21 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,520 | 🐛 288 | 🌐 TypeScript | 📅 2026-02-08 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,291 | 🐛 596 | 🌐 TypeScript | 📅 2026-02-07 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,718 | 🐛 268 | 🌐 TypeScript | 📅 2026-02-07 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 51,525 | 🐛 1,425 | 🌐 JavaScript | 📅 2026-02-06 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 34,734 | 🐛 102 | 🌐 JavaScript | 📅 2026-02-07 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 26,866 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-07 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [JS-Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,935 | 🐛 433 | 🌐 JavaScript | 📅 2026-02-07 - Npm cli and library to format JS code.
...
* [react-native](https://github.com/facebook/react-native) ⭐ 125,310 | 🐛 1,180 | 🌐 C++ | 📅 2026-02-08 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 99,814 | 🐛 1,137 | 🌐 TypeScript | 📅 2026-02-06 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 85,713 | 🐛 969 | 🌐 JavaScript | 📅 2026-02-08 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,771 | 🐛 328 | 🌐 JavaScript | 📅 2026-02-06 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,367 | 🐛 154 | 🌐 JavaScript | 📅 2026-02-05 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,126 | 🐛 44 | 🌐 HTML | 📅 2026-02-07 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 25,480 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-07 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
...
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,580 | 🐛 426 | 🌐 TypeScript | 📅 2026-02-08 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 18,642 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-06 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,248 | 🐛 140 | 🌐 TypeScript | 📅 2026-02-07 - A minimalist real-time JavaScript framework for tomorrow's apps.
* [riot](https://github.com/riot/riot) ⭐ 14,908 | 🐛 4 | 🌐 JavaScript | 📅 2025-11-21 - React-like library, but with very small size.
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,671 | 🐛 27 | 🌐 JavaScript | 📅 2026-02-03 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
...
* [Rete.js](https://github.com/retejs/rete) ⭐ 11,846 | 🐛 6 | 🌐 TypeScript | 📅 2025-11-21 - A modular framework for visual programming allows to create node based editor in browser.
* [knockout](https://github.com/knockout/knockout) ⭐ 10,546 | 🐛 375 | 🌐 JavaScript | 📅 2024-06-27 - Knockout makes it easier to create rich, responsive UIs with JavaScript.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 71,240 | 🐛 749 | 🌐 TypeScript | 📅 2026-02-07 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 51,774 | 🐛 361 | 🌐 JavaScript | 📅 2026-02-07 - simple, powerful publishing platform.
...
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,841 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-04 - powerful CMS and web app framework.
...
* [handlebars.js](https://github.com/handlebars-lang/handlebars.js) ⭐ 18,588 | 🐛 115 | 🌐 JavaScript | 📅 2026-02-07 - An extension to the Mustache templating language.
...
* [three.js](https://github.com/mrdoob/three.js) ⭐ 110,775 | 🐛 608 | 🌐 JavaScript | 📅 2026-02-06 - JavaScript 3D library.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,108 | 🐛 525 | 🌐 JavaScript | 📅 2025-12-08 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 65,658 | 🐛 1,811 | 🌐 TypeScript | 📅 2026-02-05 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 30,911 | 🐛 467 | 🌐 TypeScript | 📅 2026-02-05 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
...
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,065 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-07 - A framework for building 3D games with HTML 5 and WebGL.
...
* [paper.js](https://github.com/paperjs/paper.js) ⭐ 14,966 | 🐛 431 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
* [G6](https://github.com/antvis/g6) ⭐ 11,956 | 🐛 328 | 🌐 TypeScript | 📅 2026-01-08 - A graph visualization engine.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 10,840 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-21 - A fully featured graph theory library.
* [trianglify](https://github.com/qrohlf/trianglify) ⭐ 10,101 | 🐛 12 | 🌐 JavaScript | 📅 2025-05-12 - Low poly style background generator with d3.js.
...
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,193 | 🐛 39 | 🌐 JavaScript | 📅 2026-02-04 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 4,251 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-06 - A next-generation declarative infographic visualization engine.
...
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,256 | 🐛 63 | 🌐 TypeScript | 📅 2026-01-01 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 46,823 | 🐛 625 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
...
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,095 | 🐛 430 | 🌐 TypeScript | 📅 2026-02-07 - The JavaScript Rich Text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 52,801 | 🐛 484 | 🌐 JavaScript | 📅 2026-02-06 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,101 | 🐛 112 | 🌐 JavaScript | 📅 2026-02-05 - JavaScript PDF generation.
...
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,311 | 🐛 21 | 🌐 TypeScript | 📅 2026-01-31 - Git diff output parser and pretty HTML generator.
...
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,451 | 🐛 906 | 🌐 TypeScript | 📅 2025-09-08 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,351 | 🐛 192 | 🌐 JavaScript | 📅 2026-02-07 - Luxon is a library for working with dates and times in JavaScript.
...
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,838 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-06 - A simple, lightweight JavaScript API for handling browser cookies.
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,542 | 🐛 161 | 🌐 JavaScript | 📅 2026-01-23 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,040 | 🐛 592 | 🌐 TypeScript | 📅 2026-01-30 - Dexie.js is a wrapper library for indexedDB.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,463 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-05 - internationalisation (i18n) with JavaScript the easy way.
...
* [Bluebird](https://github.com/petkaantonov/bluebird/) ⭐ 20,804 | 🐛 127 | 🌐 JavaScript | 📅 2024-11-07 - fully featured promise library with focus on innovative features and performance.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,594 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [sanitize-html](https://github.com/apostrophecms/sanitize-html) ⭐ 4,133 | 🐛 20 | 🌐 JavaScript | 📅 2025-05-14 - sanitize-html provides a simple HTML sanitizer with a clear API.
...
* [axios](https://github.com/axios/axios) ⭐ 108,568 | 🐛 313 | 🌐 JavaScript | 📅 2026-02-06 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 48,430 | 🐛 152 | 🌐 TypeScript | 📅 2026-02-02 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,298 | 🐛 183 | 🌐 TypeScript | 📅 2026-02-04 - React Hooks library for remote data fetching.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,712 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-07 - a browser detector.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 794 | 🐛 153 | 🌐 MDX | 📅 2026-02-08 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,560 | 🐛 117 | 🌐 TypeScript | 📅 2025-09-30 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,821 | 🐛 196 | 🌐 JavaScript | 📅 2025-10-27 - JavaScript syntax highlighter.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 12,921 | 🐛 472 | 🌐 JavaScript | 📅 2026-01-21 - Lightweight, robust, elegant syntax highlighting.
* [shiki](https://github.com/shikijs/shiki) ⭐ 12,884 | 🐛 89 | 🌐 TypeScript | 📅 2026-02-06 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [PageLoadingEffects](https://github.com/codrops/PageLoadingEffects) ⭐ 644 | 🐛 0 | 🌐 CSS | 📅 2014-04-23 - Modern ways of revealing new content using SVG animations.
...
* [validator.js](https://github.com/chriso/validator.js) ⭐ 23,749 | 🐛 369 | 🌐 JavaScript | 📅 2026-02-06 - String validation and sanitization.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,631 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-08 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 25,323 | 🐛 112 | 🌐 TypeScript | 📅 2025-11-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,641 | 🐛 51 | 🌐 JavaScript | 📅 2026-02-07 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 38,523 | 🐛 151 | 🌐 TypeScript | 📅 2026-02-06 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 70,525 | 🐛 883 | 🌐 JavaScript | 📅 2026-02-02 - A framework for easily creating beautiful presentations using HTML.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,012 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-07 - An extensible low level carousel for the web, written in TypeScript.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,325 | 🐛 1,084 | 🌐 TypeScript | 📅 2025-12-23 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,165 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-07 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [filepond](https://github.com/pqina/filepond) ⭐ 16,304 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-03 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,680 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-02 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [flexboxgrid](https://github.com/kristoferjoseph/flexboxgrid/) ⭐ 9,359 | 🐛 62 | 🌐 HTML | 📅 2020-10-01 - Grid based on CSS3 flexbox.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,386 | 🐛 19 | 🌐 JavaScript | 📅 2026-02-06 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,124 | 🐛 806 | 🌐 TypeScript | 📅 2026-02-07 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 44,471 | 🐛 539 | 🌐 JavaScript | 📅 2026-02-02 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 14,808 | 🐛 1,563 | 🌐 JavaScript | 📅 2026-02-06 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 5,975 | 🐛 149 | 🌐 C | 📅 2026-02-07 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,482 | 🐛 632 | 🌐 JavaScript | 📅 2026-02-05 - Video.js - open source HTML5 & Flash video player.
...
* [mediaelement](https://github.com/johndyer/mediaelement) ⭐ 8,304 | 🐛 224 | 🌐 JavaScript | 📅 2025-11-12 - HTML5 <audio> or <video> player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. <http://www.mediaelementjs.com/>
* [clappr](https://github.com/clappr/clappr) ⭐ 7,411 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - An extensible media player for the web <http://clappr.io>
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 23,769 | 🐛 9 | 🌐 JavaScript | 📅 2025-12-12 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,252 | 🐛 41 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,870 | 🐛 13 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,685 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-07 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,878 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-06 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 137,565 | 🐛 3,297 | 🌐 JavaScript | 📅 2026-02-07 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 63,700 | 🐛 357 | 🌐 TypeScript | 📅 2026-02-06 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 56,615 | 🐛 228 | 🌐 TypeScript | 📅 2026-02-07 - The web framework for content-driven websites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,971 | 🐛 360 | 🌐 JavaScript | 📅 2026-02-04 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,513 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,203 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-06 - Static site generator for Deno.
...
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,342 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-05 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,581 | 🐛 27 | 🌐 JavaScript | 📅 2025-09-26 - It is a Next-Generation full text search library for Browser and Node.js.
* [lunr](https://github.com/olivernn/lunr.js) ⭐ 9,203 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31 - Library for use in the browser and It indexes JSON documents and provides a simple search interface for retrieving documents that best match text queries.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,246 | 🐛 2,474 | 🌐 TypeScript | 📅 2026-02-06 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,299 | 🐛 481 | 🌐 TypeScript | 📅 2026-02-03 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 32,696 | 🐛 1,540 | 🌐 TypeScript | 📅 2026-02-06 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,334 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-02-08 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,451 | 🐛 194 | 🌐 JavaScript | 📅 2026-02-07 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 13,426 | 🐛 153 | 🌐 TypeScript | 📅 2026-02-08 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 8,820 | 🐛 39 | 🌐 TypeScript | 📅 2026-02-08 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [ws](https://github.com/websockets/ws) ⭐ 22,653 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-09 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 195,527 | 🐛 388 | 🌐 JavaScript | 📅 2026-01-02 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 26,445 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-07 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [ky](https://github.com/sindresorhus/ky) ⭐ 16,319 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-25 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,671 | 🐛 500 | 🌐 TypeScript | 📅 2026-02-07 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,372 | 🐛 3 | 📅 2026-01-18 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
* [Clean Code JavaScript](https://github.com/ryanmcdermott/clean-code-javascript) ⭐ 94,289 | 🐛 119 | 🌐 JavaScript | 📅 2024-07-29 - Clean Code concepts adapted for JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 435,876 | 🐛 68 | 📅 2026-01-28
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 71,898 | 🐛 14 | 📅 2026-01-14
...
* [jnv/list](https://github.com/jnv/lists) ⭐ 10,939 | 🐛 7 | 📅 2025-05-20
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 8,800 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21
* [sotayamashita/awesome-css](https://github.com/sotayamashita/awesome-css) ⭐ 5,501 | 🐛 12 | 📅 2024-10-30
