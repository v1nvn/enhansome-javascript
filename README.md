...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,944 | 🐛 211 | 🌐 JavaScript | 📅 2026-02-08 - Packs CommonJs/AMD modules for the browser.
* [Parcel](https://github.com/parcel-bundler/parcel) ⭐ 44,045 | 🐛 585 | 🌐 JavaScript | 📅 2026-02-04 - Blazing fast, zero configuration web application bundler.
* [Rollup](https://github.com/rollup/rollup) ⭐ 26,226 | 🐛 598 | 🌐 JavaScript | 📅 2026-02-06 - Next-generation ES6 module bundler.
...
* [Zod](https://github.com/colinhacks/zod) ⭐ 41,767 | 🐛 229 | 🌐 TypeScript | 📅 2026-02-08 - TypeScript-first schema validation with built-in static type inference.
* [Yup](https://github.com/jquense/yup) ⭐ 23,689 | 🐛 239 | 🌐 TypeScript | 📅 2026-02-08 - JavaScript schema builder and validator.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,285 | 🐛 237 | 🌐 TypeScript | 📅 2026-02-05 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,870 | 🐛 226 | 🌐 JavaScript | 📅 2026-02-07 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,855 | 🐛 63 | 🌐 JavaScript | 📅 2025-11-05 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,846 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-08 - DOM-less simple JavaScript testing framework.
...
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,303 | 🐛 178 | 🌐 JavaScript | 📅 2026-01-21 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,764 | 🐛 52 | 🌐 JavaScript | 📅 2025-12-19 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,266 | 🐛 92 | 🌐 JavaScript | 📅 2026-02-09 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,524 | 🐛 291 | 🌐 TypeScript | 📅 2026-02-08 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,327 | 🐛 596 | 🌐 TypeScript | 📅 2026-02-07 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,718 | 🐛 270 | 🌐 TypeScript | 📅 2026-02-08 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 51,529 | 🐛 1,425 | 🌐 JavaScript | 📅 2026-02-06 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 34,739 | 🐛 102 | 🌐 JavaScript | 📅 2026-02-07 - Prevents bad git commit, git push and more.
* [JavaScript Standard Style](https://github.com/feross/standard) ⭐ 29,433 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11 - Opinionated, no-configuration style guide, style checker, and formatter
* [ESLint](https://github.com/eslint/eslint) ⭐ 26,873 | 🐛 92 | 🌐 JavaScript | 📅 2026-02-08 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
...
* [vue](https://github.com/vuejs/vue) ⭐ 209,904 | 🐛 622 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 125,320 | 🐛 1,169 | 🌐 C++ | 📅 2026-02-08 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 99,818 | 🐛 1,147 | 🌐 TypeScript | 📅 2026-02-06 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 85,719 | 🐛 975 | 🌐 JavaScript | 📅 2026-02-08 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,770 | 🐛 329 | 🌐 JavaScript | 📅 2026-02-06 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,369 | 🐛 154 | 🌐 JavaScript | 📅 2026-02-08 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,132 | 🐛 33 | 🌐 HTML | 📅 2026-02-09 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
...
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 25,483 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-07 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,432 | 🐛 950 | 🌐 TypeScript | 📅 2026-02-03 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,580 | 🐛 428 | 🌐 TypeScript | 📅 2026-02-08 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 18,646 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-06 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
* [Million](https://github.com/aidenybai/million) ⭐ 17,508 | 🐛 125 | 🌐 TypeScript | 📅 2025-12-11 - <1kb compiler-focused virtual DOM. It's fast!
* [inferno](https://github.com/infernojs/inferno) ⭐ 16,413 | 🐛 39 | 🌐 JavaScript | 📅 2026-01-30 - 🔥 An extremely fast, React-like JavaScript library for building modern user interfaces.
* [feathers](https://github.com/feathersjs/feathers) ⭐ 15,248 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-07 - A minimalist real-time JavaScript framework for tomorrow's apps.
* [riot](https://github.com/riot/riot) ⭐ 14,908 | 🐛 4 | 🌐 JavaScript | 📅 2025-11-21 - React-like library, but with very small size.
* [mithril.js](https://github.com/lhorie/mithril.js) ⭐ 14,672 | 🐛 27 | 🌐 JavaScript | 📅 2026-02-03 - Mithril is a client-side MVC framework (Light-weight, Robust, Fast).
* [Blockly](https://github.com/google/blockly) ⭐ 13,302 | 🐛 396 | 🌐 TypeScript | 📅 2026-02-06 - A library that adds a visual code editor to web and mobile apps by Google.
* [Rete.js](https://github.com/retejs/rete) ⭐ 11,845 | 🐛 6 | 🌐 TypeScript | 📅 2025-11-21 - A modular framework for visual programming allows to create node based editor in browser.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 7,859 | 🐛 150 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 71,255 | 🐛 751 | 🌐 TypeScript | 📅 2026-02-07 - Open source Node.js Headless CMS to easily build customisable APIs.
...
* [marko](https://github.com/marko-js/marko) ⭐ 14,313 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-06 - A fast, lightweight, HTML-based templating engine for Node.js and the browser with async, streaming, custom tags and CommonJS modules as compiled output.
* [EJS](https://github.com/mde/ejs) ⭐ 8,085 | 🐛 25 | 🌐 JavaScript | 📅 2026-01-22 - Effective JavaScript templating.
...
* [d3](https://github.com/d3/d3) ⭐ 112,283 | 🐛 27 | 🌐 Shell | 📅 2025-12-02 - A JavaScript visualization library for HTML and SVG.
* [three.js](https://github.com/mrdoob/three.js) ⭐ 110,790 | 🐛 610 | 🌐 JavaScript | 📅 2026-02-09 - JavaScript 3D library.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,110 | 🐛 525 | 🌐 JavaScript | 📅 2025-12-08 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 65,668 | 🐛 1,809 | 🌐 TypeScript | 📅 2026-02-05 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 30,915 | 🐛 467 | 🌐 TypeScript | 📅 2026-02-05 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 26,617 | 🐛 444 | 🌐 TypeScript | 📅 2026-02-08 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,067 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-07 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G2](https://github.com/antvis/G2) ⭐ 12,518 | 🐛 181 | 🌐 TypeScript | 📅 2026-02-07 - A highly interactive data-driven visualization grammar for statistical charts.
* [G6](https://github.com/antvis/g6) ⭐ 11,958 | 🐛 328 | 🌐 TypeScript | 📅 2026-01-08 - A graph visualization engine.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 10,846 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-21 - A fully featured graph theory library.
* [trianglify](https://github.com/qrohlf/trianglify) ⭐ 10,099 | 🐛 12 | 🌐 JavaScript | 📅 2025-05-12 - Low poly style background generator with d3.js.
...
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,193 | 🐛 38 | 🌐 JavaScript | 📅 2026-02-08 - Diagramming library to create static diagrams or fully interactive diagramming tools.
* [epoch](https://github.com/epochjs/epoch) ⭐ 4,956 | 🐛 69 | 🌐 HTML | 📅 2019-02-14 - A general purpose real-time charting library.
* [cubism](https://github.com/square/cubism) ⭐ 4,939 | 🐛 42 | 🌐 JavaScript | 📅 2025-04-01 - A D3 plugin for visualizing time series.
* [Infographic](https://github.com/antvis/Infographic) ⭐ 4,258 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-06 - A next-generation declarative infographic visualization engine.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 21,776 | 🐛 403 | 🌐 JavaScript | 📅 2026-02-06 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [quill](https://github.com/quilljs/quill) ⭐ 46,824 | 🐛 625 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⭐ 27,231 | 🐛 437 | 🌐 JavaScript | 📅 2026-02-07 - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,130 | 🐛 136 | 🌐 JavaScript | 📅 2026-02-05 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 19,903 | 🐛 173 | 🌐 JavaScript | 📅 2026-01-09 - A rich text editor for everyday writing. By Basecamp.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,117 | 🐛 360 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,097 | 🐛 433 | 🌐 TypeScript | 📅 2026-02-09 - The JavaScript Rich Text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 52,807 | 🐛 474 | 🌐 JavaScript | 📅 2026-02-08 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,105 | 🐛 112 | 🌐 JavaScript | 📅 2026-02-05 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,370 | 🐛 212 | 🌐 JavaScript | 📅 2025-08-20 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,312 | 🐛 21 | 🌐 TypeScript | 📅 2026-01-31 - Git diff output parser and pretty HTML generator.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,607 | 🐛 107 | 🌐 JavaScript | 📅 2026-02-06 - A utility library delivering consistency, customization, performance, & extras.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,632 | 🐛 292 | 🌐 TypeScript | 📅 2025-02-23 - A reactive programming library for JavaScript.
...
* [immutable-js](https://github.com/facebook/immutable-js) ⭐ 33,099 | 🐛 121 | 🌐 TypeScript | 📅 2026-01-28 - Immutable Data Collections including Sequence, Range, Repeat, Map, OrderedMap, Set and a sparse Vector.
...
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,457 | 🐛 906 | 🌐 TypeScript | 📅 2025-09-08 - Modern JavaScript date utility library.
* [luxon](https://github.com/moment/luxon) ⭐ 16,352 | 🐛 192 | 🌐 JavaScript | 📅 2026-02-07 - Luxon is a library for working with dates and times in JavaScript.
...
* [he](https://github.com/mathiasbynens/he) ⭐ 3,674 | 🐛 23 | 🌐 JavaScript | 📅 2021-12-29 - A robust HTML entity encoder/decoder written in JavaScript.
...
* [localForage](https://github.com/mozilla/localForage) ⭐ 25,749 | 🐛 249 | 🌐 JavaScript | 📅 2024-07-30 - Offline storage, improved. Wraps IndexedDB, WebSQL, or localStorage using a simple but powerful API.
...
* [pouchdb](https://github.com/pouchdb/pouchdb) ⭐ 17,543 | 🐛 161 | 🌐 JavaScript | 📅 2026-01-23 - Javascript db inspired by Apache CouchDB to run well within the browser.
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,042 | 🐛 593 | 🌐 TypeScript | 📅 2026-01-30 - Dexie.js is a wrapper library for indexedDB.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,596 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [sanitize-html](https://github.com/apostrophecms/sanitize-html) ⭐ 4,134 | 🐛 20 | 🌐 JavaScript | 📅 2025-05-14 - sanitize-html provides a simple HTML sanitizer with a clear API.
...
* [axios](https://github.com/axios/axios) ⭐ 108,570 | 🐛 315 | 🌐 JavaScript | 📅 2026-02-09 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 48,436 | 🐛 155 | 🌐 TypeScript | 📅 2026-02-09 - Hooks for fetching, caching and updating asynchronous data in React.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,489 | 🐛 226 | 🌐 JavaScript | 📅 2023-06-03 - A modern approach for Computer Vision on the web.
...
* [bowser](https://github.com/ded/bowser) ⭐ 5,713 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-08 - a browser detector.
...
* [bencher](https://github.com/bencherdev/bencher) ⭐ 794 | 🐛 153 | 🌐 MDX | 📅 2026-02-09 - A suite of continuous benchmarking tools designed to catch performance regressions in CI.
...
* [partytown](https://github.com/BuilderIO/partytown) ⭐ 13,634 | 🐛 78 | 🌐 TypeScript | 📅 2025-09-09 - Relocate resource intensive third-party scripts off of the main thread and into a web worker.
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,562 | 🐛 117 | 🌐 TypeScript | 📅 2025-09-30 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,820 | 🐛 196 | 🌐 JavaScript | 📅 2025-10-27 - JavaScript syntax highlighter.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 12,922 | 🐛 472 | 🌐 JavaScript | 📅 2026-01-21 - Lightweight, robust, elegant syntax highlighting.
* [shiki](https://github.com/shikijs/shiki) ⭐ 12,885 | 🐛 89 | 🌐 TypeScript | 📅 2026-02-06 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [jquery-validation](https://github.com/jzaefferer/jquery-validation) ⭐ 10,346 | 🐛 42 | 🌐 JavaScript | 📅 2026-01-22 - jQuery Validation Plugin.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,631 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-09 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 25,327 | 🐛 112 | 🌐 TypeScript | 📅 2025-11-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,641 | 🐛 47 | 🌐 JavaScript | 📅 2026-02-08 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 38,528 | 🐛 151 | 🌐 TypeScript | 📅 2026-02-06 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 70,530 | 🐛 883 | 🌐 JavaScript | 📅 2026-02-02 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,782 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-28 - Mobile touch slider and framework with hardware accelerated transitions.
...
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,015 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-07 - An extensible low level carousel for the web, written in TypeScript.
...
* [Flickity](https://github.com/metafizzy/flickity) ⭐ 7,592 | 🐛 123 | 🌐 JavaScript | 📅 2024-05-29 - Touch, responsive, flickable galleries.
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,329 | 🐛 1,085 | 🌐 TypeScript | 📅 2025-12-23 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,166 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-07 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [filepond](https://github.com/pqina/filepond) ⭐ 16,305 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-03 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [hint.css](https://github.com/chinchang/hint.css) ⭐ 8,463 | 🐛 54 | 🌐 CSS | 📅 2024-10-17 - A tooltip library in CSS for your lovely websites.
...
* [SweetAlert2](https://github.com/sweetalert2/sweetalert2) ⭐ 18,030 | 🐛 8 | 🌐 JavaScript | 📅 2026-02-02 - An awesome replacement for JavaScript's alert.
...
* [vex](https://github.com/HubSpot/vex) ⭐ 6,912 | 🐛 55 | 🌐 CSS | 📅 2023-02-26 - A modern dialog library which is highly configurable and easy to style.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,681 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-02 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,387 | 🐛 19 | 🌐 JavaScript | 📅 2026-02-06 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,126 | 🐛 807 | 🌐 TypeScript | 📅 2026-02-07 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
...
* [hammer.js](https://github.com/hammerjs/hammer.js) ⭐ 24,389 | 🐛 318 | 🌐 JavaScript | 📅 2026-01-04 - A JavaScript library for multi-touch gestures.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 44,474 | 🐛 540 | 🌐 JavaScript | 📅 2026-02-02 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 14,812 | 🐛 1,564 | 🌐 JavaScript | 📅 2026-02-06 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 5,980 | 🐛 149 | 🌐 C | 📅 2026-02-09 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,486 | 🐛 632 | 🌐 JavaScript | 📅 2026-02-05 - Video.js - open source HTML5 & Flash video player.
* [flv.js](https://github.com/bilibili/flv.js) ⭐ 23,256 | 🐛 449 | 🌐 JavaScript | 📅 2024-07-07 - An HTML5 Flash Video (FLV) Player written in pure JavaScript without Flash.
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,469 | 🐛 166 | 🌐 TypeScript | 📅 2026-02-07 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
* [mediaelement](https://github.com/johndyer/mediaelement) ⭐ 8,305 | 🐛 224 | 🌐 JavaScript | 📅 2025-11-12 - HTML5 <audio> or <video> player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. <http://www.mediaelementjs.com/>
* [clappr](https://github.com/clappr/clappr) ⭐ 7,413 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - An extensible media player for the web <http://clappr.io>
...
* [particles.js](https://github.com/VincentGarreau/particles.js) ⭐ 30,372 | 🐛 366 | 🌐 JavaScript | 📅 2024-03-28 - A lightweight JavaScript library for creating particles.
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 23,772 | 🐛 9 | 🌐 JavaScript | 📅 2025-12-12 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,252 | 🐛 41 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,871 | 🐛 13 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,686 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-08 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,879 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-06 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 137,565 | 🐛 3,304 | 🌐 JavaScript | 📅 2026-02-09 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 63,712 | 🐛 358 | 🌐 TypeScript | 📅 2026-02-06 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 56,648 | 🐛 238 | 🌐 TypeScript | 📅 2026-02-09 - The web framework for content-driven websites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,969 | 🐛 361 | 🌐 JavaScript | 📅 2026-02-04 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,513 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,204 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-08 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 10,613 | 🐛 143 | 🌐 TypeScript | 📅 2026-02-08 - Official JavaScript / TypeScript library for the OpenAI API.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,583 | 🐛 27 | 🌐 JavaScript | 📅 2025-09-26 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,249 | 🐛 2,474 | 🌐 TypeScript | 📅 2026-02-06 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,300 | 🐛 482 | 🌐 TypeScript | 📅 2026-02-03 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 32,709 | 🐛 1,544 | 🌐 TypeScript | 📅 2026-02-06 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,336 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-02-08 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,452 | 🐛 194 | 🌐 JavaScript | 📅 2026-02-08 MongoDB object modeling designed to work in an asynchronous environment.
* [Knex](https://github.com/knex/knex) ⭐ 20,207 | 🐛 702 | 🌐 JavaScript | 📅 2026-02-03 A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 13,429 | 🐛 152 | 🌐 TypeScript | 📅 2026-02-09 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 8,823 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-09 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [Socket.io](https://github.com/socketio/socket.io) ⭐ 62,863 | 🐛 203 | 🌐 TypeScript | 📅 2026-01-23 The most widely used WebSocket library for real-time applications. Supports auto-reconnection, rooms, and fallbacks (e.g., polling).
* [ws](https://github.com/websockets/ws) ⭐ 22,654 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-09 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.

## Generative AI

* [KaibanJS](https://github.com/kaiban-ai/KaibanJS) ⭐ 1,336 | 🐛 64 | 🌐 TypeScript | 📅 2025-12-12 - KaibanJS is an open-source framework browser-compatibility of orchestration of multi-agent ai systems using a Kanban-inspired architecture.

## Misc

* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 195,532 | 🐛 390 | 🌐 JavaScript | 📅 2026-01-02 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 26,449 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-07 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [ky](https://github.com/sindresorhus/ky) ⭐ 16,320 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-25 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,671 | 🐛 501 | 🌐 TypeScript | 📅 2026-02-08 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,386 | 🐛 3 | 📅 2026-01-18 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [Functional-Light JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,795 | 🐛 26 | 🌐 JavaScript | 📅 2023-12-26 - Pragmatic, balanced FP in JavaScript.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 71,913 | 🐛 15 | 📅 2026-01-14
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,203 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,549 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 10,944 | 🐛 7 | 📅 2025-05-20
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 8,801 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,449 | 🐛 53 | 📅 2025-07-20
