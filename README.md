...
* [Bit](https://github.com/teambit/bit) ⭐ 18,350 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-09 - Create, find and reuse components (React, Angular, Node etc.) across applications.

## Loaders

*Module or loading system for JavaScript.*

* [browserify](https://github.com/substack/node-browserify) ⭐ 14,733 | 🐛 378 | 🌐 JavaScript | 📅 2024-12-21 - Browser-side require() the node.js way.
...
* [webpack](https://github.com/webpack/webpack) ⭐ 65,947 | 🐛 210 | 🌐 JavaScript | 📅 2026-02-09 - Packs CommonJs/AMD modules for the browser.
...
* [Terser](https://github.com/terser/terser) ⭐ 9,231 | 🐛 328 | 🌐 JavaScript | 📅 2026-02-02 - parser, mangler and compressor toolkit for ES6+

## Type Checkers

* [Zod](https://github.com/colinhacks/zod) ⭐ 41,781 | 🐛 232 | 🌐 TypeScript | 📅 2026-02-08 - TypeScript-first schema validation with built-in static type inference.
...
* [jest](https://github.com/facebook/jest) ⭐ 45,288 | 🐛 238 | 🌐 TypeScript | 📅 2026-02-05 - Painless JavaScript Unit Testing.
* [mocha](https://github.com/mochajs/mocha) ⭐ 22,871 | 🐛 226 | 🌐 JavaScript | 📅 2026-02-07 - Simple, flexible, fun JavaScript test framework for node.js & the browser.
* [ava](https://github.com/avajs/ava) ⭐ 20,856 | 🐛 63 | 🌐 JavaScript | 📅 2025-11-05 - 🚀 Futuristic JavaScript test runner
* [jasmine](https://github.com/jasmine/jasmine) ⭐ 15,847 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-08 - DOM-less simple JavaScript testing framework.
* [TestCafe](https://github.com/DevExpress/testcafe) ⭐ 9,904 | 🐛 19 | 🌐 JavaScript | 📅 2026-01-21 - Automated browser testing for the modern web development stack.
...
* [react testing library](https://github.com/kentcdodds/react-testing-library) ⭐ 19,530 | 🐛 74 | 🌐 JavaScript | 📅 2026-01-19 - Simple and complete React DOM testing utilities that encourage good testing practices.
* [Supertest](https://github.com/visionmedia/supertest) ⭐ 14,304 | 🐛 178 | 🌐 JavaScript | 📅 2026-01-21 - A popular HTTP assertion library for testing REST APIs, often used with other testing frameworks like Mocha or Jest
* [Sinon.JS](https://github.com/sinonjs/sinon) ⭐ 9,764 | 🐛 52 | 🌐 JavaScript | 📅 2025-12-19 - Test spies, stubs, and mocks for JavaScript.
* [chai](https://github.com/chaijs/chai) ⭐ 8,266 | 🐛 91 | 🌐 JavaScript | 📅 2026-02-09 - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework.
...
* [puppeteer](https://github.com/GoogleChrome/puppeteer) ⭐ 93,535 | 🐛 287 | 🌐 TypeScript | 📅 2026-02-09 - Headless Chrome Node.js API by official Google Chrome team.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 82,373 | 🐛 581 | 🌐 TypeScript | 📅 2026-02-10 - Node.js library to automate Chromium, Firefox and WebKit with a single API.
...
* [webdriverio](https://github.com/webdriverio/webdriverio) ⭐ 9,718 | 🐛 269 | 🌐 TypeScript | 📅 2026-02-09 - Next-gen WebDriver test automation framework for Node.js.
...
* [prettier](https://github.com/prettier/prettier) ⭐ 51,532 | 🐛 1,426 | 🌐 JavaScript | 📅 2026-02-06 - Prettier is an opinionated code formatter.
* [husky](https://github.com/typicode/husky) ⭐ 34,746 | 🐛 102 | 🌐 JavaScript | 📅 2026-02-07 - Prevents bad git commit, git push and more.
...
* [ESLint](https://github.com/eslint/eslint) ⭐ 26,881 | 🐛 92 | 🌐 JavaScript | 📅 2026-02-09 - A fully pluggable tool for identifying and reporting on patterns in JavaScript.
* [JSHint](https://github.com/jshint/jshint/) ⭐ 9,068 | 🐛 461 | 🌐 JavaScript | 📅 2025-02-13 - JSHint is a tool that helps to detect errors and potential problems in your JavaScript code.
...
* [vue](https://github.com/vuejs/vue) ⭐ 209,905 | 🐛 619 | 🌐 TypeScript | 📅 2024-10-10 - Intuitive, fast & composable MVVM for building interactive interfaces.
* [react-native](https://github.com/facebook/react-native) ⭐ 125,332 | 🐛 1,176 | 🌐 C++ | 📅 2026-02-10 - A framework for building native apps with React.
* [angular](https://github.com/angular/angular) ⭐ 99,817 | 🐛 1,125 | 🌐 TypeScript | 📅 2026-02-10 - Angular is a development platform for building mobile and desktop web applications using Typescript/JavaScript and other languages.
* [svelte](https://github.com/sveltejs/svelte) ⭐ 85,725 | 🐛 975 | 🌐 JavaScript | 📅 2026-02-10 - Svelte is a new way to build web applications. It's a compiler that takes your declarative components and converts them into efficient JavaScript that surgically updates the DOM.
* [angular.js](https://github.com/angular/angular.js) ⚠️ Archived - HTML enhanced for web apps. (deprecated)
* [meteor](https://github.com/meteor/meteor) ⭐ 44,773 | 🐛 331 | 🌐 JavaScript | 📅 2026-02-09 - An ultra-simple, database-everywhere, data-on-the-wire, pure-javascript web framework.
* [preact](https://github.com/developit/preact) ⭐ 38,371 | 🐛 155 | 🌐 JavaScript | 📅 2026-02-08 - Fast 3kb React alternative with the same ES6 API. Components & Virtual DOM.
* [Alpine.js](https://github.com/alpinejs/alpine) ⭐ 31,134 | 🐛 23 | 🌐 HTML | 📅 2026-02-09 - offers you the reactive and declarative nature of big frameworks like Vue or React at a much lower cost.
* [backbone](https://github.com/jashkenas/backbone) ⭐ 28,115 | 🐛 62 | 🌐 JavaScript | 📅 2025-04-01 - Give your JS App some Backbone with Models, Views, Collections, and Events.
* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 25,485 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-07 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding.
* [nativescript](https://github.com/NativeScript/NativeScript) ⭐ 25,436 | 🐛 950 | 🌐 TypeScript | 📅 2026-02-03 - Build truly native cross-platform iOS and Android apps with JavaScript.
* [ember.js](https://github.com/emberjs/ember.js) ⭐ 22,580 | 🐛 429 | 🌐 TypeScript | 📅 2026-02-10 - A JavaScript framework for creating ambitious web applications.
...
* [Adonis](https://github.com/adonisjs/core) ⭐ 18,656 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-06 - The Node.js Framework highly focused on developer ergonomics, stability and confidence.
...
* [Blockly](https://github.com/google/blockly) ⭐ 13,304 | 🐛 396 | 🌐 TypeScript | 📅 2026-02-06 - A library that adds a visual code editor to web and mobile apps by Google.
...
* [litegraph.js](https://github.com/jagenjo/litegraph.js) ⭐ 7,861 | 🐛 150 | 🌐 JavaScript | 📅 2024-08-01 - A graph node engine and editor similar to PD or UDK Blueprints, comes with its own editor in HTML5 Canvas2D.
...
* [Strapi](https://github.com/strapi/strapi) ⭐ 71,269 | 🐛 745 | 🌐 TypeScript | 📅 2026-02-09 - Open source Node.js Headless CMS to easily build customisable APIs.
* [Ghost](https://github.com/tryghost/Ghost) ⭐ 51,794 | 🐛 368 | 🌐 JavaScript | 📅 2026-02-10 - simple, powerful publishing platform.
* [Reaction Commerce](https://github.com/reactioncommerce/reaction) ⭐ 12,434 | 🐛 94 | 🌐 JavaScript | 📅 2025-08-21 - reactive CMS, real-time architecture and design.
* [KeystoneJS](https://github.com/keystonejs/keystone) ⭐ 9,842 | 🐛 137 | 🌐 TypeScript | 📅 2026-02-09 - powerful CMS and web app framework.
* [Apostrophe](https://github.com/punkave/apostrophe) ⭐ 4,522 | 🐛 130 | 🌐 JavaScript | 📅 2026-02-09 - CMS with content editing and essential services.
...
* [d3](https://github.com/d3/d3) ⭐ 112,288 | 🐛 27 | 🌐 Shell | 📅 2025-12-02 - A JavaScript visualization library for HTML and SVG.
* [three.js](https://github.com/mrdoob/three.js) ⭐ 110,810 | 🐛 604 | 🌐 JavaScript | 📅 2026-02-10 - JavaScript 3D library.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,116 | 🐛 525 | 🌐 JavaScript | 📅 2025-12-08 - Simple HTML5 Charts using the \<canvas> tag.
* [echarts](https://github.com/apache/echarts) ⭐ 65,677 | 🐛 1,810 | 🌐 TypeScript | 📅 2026-02-05 - Enterprise Charts.
* [fabric.js](https://github.com/kangax/fabric.js) ⭐ 30,917 | 🐛 467 | 🌐 TypeScript | 📅 2026-02-05 - JavaScript Canvas Library, SVG-to-Canvas (& canvas-to-SVG) Parser.
* [recharts](https://github.com/recharts/recharts) ⭐ 26,623 | 🐛 452 | 🌐 TypeScript | 📅 2026-02-09 - Redefined chart library built with React and D3.
* [BabylonJS](https://github.com/BabylonJS/Babylon.js) ⭐ 25,069 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-09 - A framework for building 3D games with HTML 5 and WebGL.
...
* [G6](https://github.com/antvis/g6) ⭐ 11,960 | 🐛 329 | 🌐 TypeScript | 📅 2026-01-08 - A graph visualization engine.
...
* [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) ⭐ 10,847 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-21 - A fully featured graph theory library.
...
* [dc.js](https://github.com/dc-js/dc.js) ⭐ 7,453 | 🐛 413 | 🌐 JavaScript | 📅 2024-07-31 - Multi-Dimensional charting built to work natively with crossfilter rendered with d3.js
...
* [Frappe Gantt](https://github.com/frappe/gantt) ⭐ 5,836 | 🐛 74 | 🌐 JavaScript | 📅 2025-10-31 - A simple, interactive, modern gantt chart library for the web.
* [jointjs](https://github.com/clientIO/joint) ⭐ 5,196 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-09 - Diagramming library to create static diagrams or fully interactive diagramming tools.
...
* [Infographic](https://github.com/antvis/Infographic) ⭐ 4,263 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-06 - A next-generation declarative infographic visualization engine.
...
* [HANDSONTABLE](https://github.com/handsontable/handsontable) ⭐ 21,780 | 🐛 401 | 🌐 JavaScript | 📅 2026-02-10 - Handsontable is a JavaScript/HTML5 Spreadsheet Library for Developers
...
* [Jspreadsheet CE](https://github.com/jspreadsheet/ce) ⭐ 7,121 | 🐛 142 | 🌐 JavaScript | 📅 2026-01-13 - Jspreadsheet is a lightweight vanilla javascript plugin to create amazing web-based interactive tables and spreadsheets compatible with other spreadsheet software.
* [RevoGrid](https://github.com/revolist/revogrid) ⭐ 3,258 | 🐛 63 | 🌐 TypeScript | 📅 2026-01-01 - RevoGrid is a fast, responsive excel like data grid library for modern web applications.
...
* [quill](https://github.com/quilljs/quill) ⭐ 46,832 | 🐛 626 | 🌐 TypeScript | 📅 2025-07-25 - A cross browser rich text editor with an API.
* [CodeMirror](https://github.com/codemirror/CodeMirror) ⭐ 27,229 | 🐛 437 | 🌐 JavaScript | 📅 2026-02-07 - In-browser code editor.
* [ace](https://github.com/ajaxorg/ace) ⭐ 27,129 | 🐛 136 | 🌐 JavaScript | 📅 2026-02-09 - Ace (Ajax.org Cloud9 Editor).
* [Draft.js](https://github.com/facebook/draft-js) ⚠️ Archived - A React framework for building text editors.
* [trix](https://github.com/basecamp/trix) ⭐ 19,905 | 🐛 173 | 🌐 JavaScript | 📅 2026-01-09 - A rich text editor for everyday writing. By Basecamp.
* [medium-editor](https://github.com/yabwe/medium-editor) ⭐ 16,118 | 🐛 360 | 🌐 JavaScript | 📅 2024-10-24 - Medium.com WYSIWYG editor clone.
* [TinyMCE](https://github.com/tinymce/tinymce) ⭐ 16,098 | 🐛 435 | 🌐 TypeScript | 📅 2026-02-10 - The JavaScript Rich Text editor.
* [jsoneditor](https://github.com/josdejong/jsoneditor) ⭐ 12,184 | 🐛 231 | 🌐 JavaScript | 📅 2026-02-07 - A web-based tool to view, edit and format JSON.
...
* [Squire](https://github.com/neilj/Squire) ⭐ 4,893 | 🐛 54 | 🌐 TypeScript | 📅 2026-01-12 - HTML5 rich text editor.
...
* [PDF.js](https://github.com/mozilla/pdf.js) ⭐ 52,815 | 🐛 470 | 🌐 JavaScript | 📅 2026-02-09 - PDF Reader in JavaScript.
* [jsPDF](https://github.com/MrRio/jsPDF) ⭐ 31,108 | 🐛 112 | 🌐 JavaScript | 📅 2026-02-09 - JavaScript PDF generation.
* [Papa Parse](https://github.com/mholt/PapaParse) ⭐ 13,372 | 🐛 212 | 🌐 JavaScript | 📅 2025-08-20 - A powerful CSV library that supports parsing CSV files/strings and also exporting to CSV.
* [diff2html](https://github.com/rtfpessoa/diff2html) ⭐ 3,313 | 🐛 21 | 🌐 TypeScript | 📅 2026-01-31 - Git diff output parser and pretty HTML generator.
...
* [lodash](https://github.com/lodash/lodash) ⭐ 61,608 | 🐛 107 | 🌐 JavaScript | 📅 2026-02-06 - A utility library delivering consistency, customization, performance, & extras.
...
* [lazy.js](https://github.com/dtao/lazy.js) ⭐ 5,993 | 🐛 59 | 🌐 JavaScript | 📅 2020-07-15 - Like Underscore, but lazier.
...
* [RxJS](https://github.com/ReactiveX/rxjs) ⭐ 31,631 | 🐛 292 | 🌐 TypeScript | 📅 2025-02-23 - A reactive programming library for JavaScript.
* [MobX](https://github.com/mobxjs/mobx) ⭐ 28,175 | 🐛 83 | 🌐 TypeScript | 📅 2026-01-04 - TFRP library for simple, scalable state management.
...
* [dayjs](https://github.com/iamkun/dayjs) ⭐ 48,541 | 🐛 1,188 | 🌐 JavaScript | 📅 2026-01-12 - Day.js 2KB immutable date library alternative to Moment.js with the same modern API.
* [moment](https://github.com/moment/moment) ⭐ 48,073 | 🐛 290 | 🌐 JavaScript | 📅 2024-08-14 - Parse, validate, manipulate, and display dates in JavaScript.
* [date-fns](https://github.com/date-fns/date-fns) ⭐ 36,461 | 🐛 908 | 🌐 TypeScript | 📅 2025-09-08 - Modern JavaScript date utility library.
...
* [URI.js](https://github.com/medialize/URI.js/) ⭐ 6,248 | 🐛 104 | 🌐 JavaScript | 📅 2023-08-27 - JavaScript URL mutation library.
...
* [js-cookie](https://github.com/js-cookie/js-cookie) ⭐ 22,840 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-06 - A simple, lightweight JavaScript API for handling browser cookies.
...
* [Dexie.js](https://github.com/dexie/Dexie.js) ⭐ 14,046 | 🐛 593 | 🌐 TypeScript | 📅 2026-01-30 - Dexie.js is a wrapper library for indexedDB.
...
* [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,566 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 - Embedded Persistent database for Browsers, nw\.js, electron.
...
* [TinyColor](https://github.com/bgrins/TinyColor) ⭐ 5,224 | 🐛 102 | 🌐 JavaScript | 📅 2024-06-26 - Fast, small color manipulation and conversion for JavaScript.
...
* [i18next](https://github.com/i18next/i18next) ⭐ 8,468 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-05 - internationalisation (i18n) with JavaScript the easy way.
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,604 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - A DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG.
...
* [sanitize-html](https://github.com/apostrophecms/sanitize-html) ⭐ 4,135 | 🐛 20 | 🌐 JavaScript | 📅 2025-05-14 - sanitize-html provides a simple HTML sanitizer with a clear API.
...
* [axios](https://github.com/axios/axios) ⭐ 108,576 | 🐛 317 | 🌐 JavaScript | 📅 2026-02-09 - Promise based HTTP client for the browser and node.js.
* [React Query](https://github.com/tannerlinsley/react-query) ⭐ 48,450 | 🐛 156 | 🌐 TypeScript | 📅 2026-02-09 - Hooks for fetching, caching and updating asynchronous data in React.
* [SWR](https://github.com/vercel/swr) ⭐ 32,300 | 🐛 183 | 🌐 TypeScript | 📅 2026-02-04 - React Hooks library for remote data fetching.
...
* [bottleneck](https://github.com/SGrondin/bottleneck) ⭐ 1,971 | 🐛 89 | 🌐 JavaScript | 📅 2024-01-23 - A powerful rate limiter that makes throttling easy.
...
* [tracking.js](https://github.com/eduardolundgren/tracking.js) ⭐ 9,490 | 🐛 226 | 🌐 JavaScript | 📅 2023-06-03 - A modern approach for Computer Vision on the web.
...
* [m2cgen](https://github.com/BayesWitnesses/m2cgen) ⭐ 2,955 | 🐛 60 | 🌐 Python | 📅 2024-08-03 - A CLI tool to transpile trained classic ML models into a native JavaScript code with zero dependencies.
...
* [comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,564 | 🐛 117 | 🌐 TypeScript | 📅 2025-09-30 - Comlink is a tiny library (1.1kB), that removes the mental barrier of thinking about postMessage and hides the fact that you are working with workers.
...
* [Highlight.js](https://github.com/isagalaev/highlight.js) ⭐ 24,823 | 🐛 196 | 🌐 JavaScript | 📅 2025-10-27 - JavaScript syntax highlighter.
* [PrismJS](https://github.com/PrismJS/prism) ⭐ 12,924 | 🐛 472 | 🌐 JavaScript | 📅 2026-01-21 - Lightweight, robust, elegant syntax highlighting.
* [shiki](https://github.com/shikijs/shiki) ⭐ 12,895 | 🐛 90 | 🌐 TypeScript | 📅 2026-02-06 - Code highlighter powered by VS Code TextMate grammars. Accurate, themeable, works in Node or browser, great for JS and TS.
...
* [pace](https://github.com/HubSpot/pace) ⭐ 15,655 | 🐛 276 | 🌐 CSS | 📅 2024-02-26 - Automatically add a progress bar to your site.
* [Spin.js](https://github.com/fgnass/spin.js) ⭐ 9,295 | 🐛 15 | 🌐 CSS | 📅 2024-07-19 - A spinning activity indicator.
* [progressbar.js](https://github.com/kimmobrunfeldt/progressbar.js) ⭐ 7,879 | 🐛 69 | 🌐 JavaScript | 📅 2024-11-02 - Beautiful and responsive progress bars with animated SVG paths.
...
* [jquery-validation](https://github.com/jzaefferer/jquery-validation) ⭐ 10,345 | 🐛 40 | 🌐 JavaScript | 📅 2026-01-22 - jQuery Validation Plugin.
...
* [vest](https://github.com/ealush/vest) ⭐ 2,631 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-10 - 🦺 Declarative form validation framework inspired by unit testing.
...
* [driver.js](https://github.com/kamranahmedse/driver.js) ⭐ 25,329 | 🐛 112 | 🌐 TypeScript | 📅 2025-11-18 - Powerful yet light-weight, vanilla JavaScript engine to drive the user's focus across the page
...
* [shepherd](https://github.com/HubSpot/shepherd) ⭐ 13,641 | 🐛 52 | 🌐 JavaScript | 📅 2026-02-09 - Guide your users through a tour of your app.
...
* [notifire](https://github.com/notifirehq/notifire) ⭐ 38,535 | 🐛 154 | 🌐 TypeScript | 📅 2026-02-09 - Open-source notification infrastructure for products.
...
* [reveal.js](https://github.com/hakimel/reveal.js) ⭐ 70,534 | 🐛 883 | 🌐 JavaScript | 📅 2026-02-09 - A framework for easily creating beautiful presentations using HTML.
* [Swiper](https://github.com/nolimits4web/Swiper) ⭐ 41,781 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-28 - Mobile touch slider and framework with hardware accelerated transitions.
* [impress.js](https://github.com/impress/impress.js) ⭐ 38,587 | 🐛 59 | 🌐 JavaScript | 📅 2026-01-24 - It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com.
* [slick](https://github.com/kenwheeler/slick) ⭐ 28,615 | 🐛 1,350 | 🌐 JavaScript | 📅 2026-01-28 - The last carousel you'll ever need.
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ⭐ 25,064 | 🐛 162 | 🌐 JavaScript | 📅 2025-12-04 - JavaScript image gallery for mobile and desktop, modular, framework independent.
* [Embla Carousel](https://github.com/davidcetinkaya/embla-carousel) ⭐ 8,013 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-07 - An extensible low level carousel for the web, written in TypeScript.
...
* [bespoke.js](https://github.com/bespokejs/bespoke) ⭐ 4,809 | 🐛 5 | 🌐 JavaScript | 📅 2020-09-08 - DIY Presentation Micro-Framework
...
* [fullcalendar](https://github.com/fullcalendar/fullcalendar) ⭐ 20,332 | 🐛 1,085 | 🌐 TypeScript | 📅 2025-12-23 - Full-sized drag & drop event calendar (jQuery plugin).
...
* [Schedule-X](https://github.com/schedule-x/schedule-x) ⭐ 2,170 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-09 - Material design event calendar. Features drag & drop, dark mode, multiple views and more.
...
* [chosen](https://github.com/harvesthq/chosen) ⭐ 22,345 | 🐛 311 | 🌐 HTML | 📅 2024-12-02 - A library for making long, unwieldy select boxes more friendly.
* [selectize.js](https://github.com/selectize/selectize.js) ⭐ 13,060 | 🐛 49 | 🌐 SCSS | 📅 2026-02-06 - Selectize is the hybrid of a textbox and `<select>` box. It's jQuery based and it has autocomplete and native-feeling keyboard navigation; useful for tagging, contact lists, etc.
...
* [dropzone](https://github.com/enyo/dropzone) ⭐ 18,396 | 🐛 151 | 🌐 JavaScript | 📅 2024-07-15 - Dropzone is an easy to use drag'n'drop library. It supports image previews and shows nice progress bars.
* [filepond](https://github.com/pqina/filepond) ⭐ 16,305 | 🐛 140 | 🌐 JavaScript | 📅 2026-02-03 - A JavaScript library that can upload anything you throw at it, optimizes images for faster uploads, and offers a great, accessible, silky smooth user experience.
...
* [vex](https://github.com/HubSpot/vex) ⭐ 6,914 | 🐛 55 | 🌐 CSS | 📅 2023-02-26 - A modern dialog library which is highly configurable and easy to style.
...
* [baguetteBox.js](https://github.com/feimosi/baguetteBox.js) ⭐ 2,497 | 🐛 54 | 🌐 JavaScript | 📅 2025-11-09 - Simple and easy to use lightbox script written in pure JavaScript.
...
* [locomotive-scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,682 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-02 - Detects the elements in viewport and smooth scrolling with parallax.
...
* [jQuery-menu-aim](https://github.com/kamens/jQuery-menu-aim) ⭐ 7,652 | 🐛 66 | 🌐 JavaScript | 📅 2018-11-01 - jQuery plugin to fire events when user's cursor aims at particular dropdown menu items. For making responsive mega dropdowns like Amazon's.
...
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,390 | 🐛 19 | 🌐 JavaScript | 📅 2026-02-06 - A professional front-end template for building fast, robust, and adaptable web apps or sites.
* [Wasp](https://github.com/wasp-lang/wasp) ⭐ 18,128 | 🐛 807 | 🌐 TypeScript | 📅 2026-02-09 Wasp is a declarative domain-specific language for developing, building, and deploying modern Javascript full-stack web apps with less code.
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,115 | 🐛 13 | 🌐 HTML | 📅 2024-07-16 - A few simple, but solid patterns for responsive HTML emails. Even in Outlook.
...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 44,478 | 🐛 542 | 🌐 JavaScript | 📅 2026-02-09 - JavaScript library for mobile-friendly interactive maps.
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 14,813 | 🐛 1,564 | 🌐 JavaScript | 📅 2026-02-09 - Open Source WebGL virtual globe and map engine.
* [gmaps](https://github.com/HPNeo/gmaps) ⚠️ Archived - The easiest way to use Google Maps.
* [H3js](https://github.com/uber/h3) ⭐ 5,981 | 🐛 149 | 🌐 C | 📅 2026-02-09 - Hexagonal hierarchical geospatial indexing system ported to javascript by Uber for geospatial visualization.
...
* [video.js](https://github.com/videojs/video.js) ⭐ 39,490 | 🐛 632 | 🌐 JavaScript | 📅 2026-02-09 - Video.js - open source HTML5 & Flash video player.
...
* [hls.js](https://github.com/video-dev/hls.js) ⭐ 16,469 | 🐛 167 | 🌐 TypeScript | 📅 2026-02-09 -  A JavaScript library that implements an HTTP Live Streaming client. It relies on HTML5 video and MediaSource Extensions for playback.
* [mediaelement](https://github.com/johndyer/mediaelement) ⭐ 8,307 | 🐛 224 | 🌐 JavaScript | 📅 2025-11-12 - HTML5 <audio> or <video> player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. <http://www.mediaelementjs.com/>
* [clappr](https://github.com/clappr/clappr) ⭐ 7,414 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-09 - An extensible media player for the web <http://clappr.io>
...
* [GreenSock-JS](https://github.com/greensock/GreenSock-JS) ⭐ 23,775 | 🐛 9 | 🌐 JavaScript | 📅 2025-12-12 - High-performance HTML5 animations that work in all major browsers.
* [velocity](https://github.com/julianshapiro/velocity) ⭐ 17,252 | 🐛 41 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [barbajs](https://github.com/barbajs/barba) ⭐ 12,872 | 🐛 13 | 🌐 TypeScript | 📅 2024-12-02 - It helps you create fluid and smooth transitions between your website's pages.
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) ⚠️ Archived - A Performant Transitions and Animations Library.
* [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,688 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-09 - A new and improved version of particles.js with bug fixes and many new features.
...
* [Babel (Formerly 6to5)](https://github.com/babel/babel) ⭐ 43,878 | 🐛 756 | 🌐 TypeScript | 📅 2026-02-06 - Turn ES6+ code into vanilla ES5 with no runtime.
...
* [Next.js](https://github.com/vercel/next.js) ⭐ 137,581 | 🐛 3,292 | 🌐 JavaScript | 📅 2026-02-10 - React powered static site generator, and they say "All the tools you need to make the Web. Faster.".
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 63,728 | 🐛 361 | 🌐 TypeScript | 📅 2026-02-06 - React-based static site generator by Facebook, ideal for content-centric websites.
* [Astro](https://github.com/withastro/astro) ⭐ 56,670 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-10 - The web framework for content-driven websites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby) ⭐ 55,966 | 🐛 360 | 🌐 JavaScript | 📅 2026-02-04 - React-based static site generator.
* [Gridsome](https://github.com/gridsome/gridsome) ⭐ 8,513 | 🐛 581 | 🌐 JavaScript | 📅 2024-04-10 - Vue-powered static site generator.
* [Lume](https://github.com/lumeland/lume) ⭐ 2,207 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-09 - Static site generator for Deno.

## SDK

* [OpenAI SDK](https://github.com/openai/openai-node) ⭐ 10,615 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-09 - Official JavaScript / TypeScript library for the OpenAI API.
* [Stripe Node.js SDK](https://github.com/stripe/stripe-node) ⭐ 4,343 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-05 - Stripe Node.js SDK lets you integrate payments, subscriptions, and billing into your JavaScript/TypeScript apps.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,586 | 🐛 27 | 🌐 JavaScript | 📅 2025-09-26 - It is a Next-Generation full text search library for Browser and Node.js.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,256 | 🐛 2,473 | 🌐 TypeScript | 📅 2026-02-09 Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB.
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,305 | 🐛 484 | 🌐 TypeScript | 📅 2026-02-03 ORM for TypeScript and JavaScript, Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
* [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) ⭐ 32,725 | 🐛 1,546 | 🌐 TypeScript | 📅 2026-02-09 Headless TypeScript ORM with a head. Runs on Node, Bun and Deno.
* [Sequelize](https://github.com/sequelize/sequelize) ⭐ 30,337 | 🐛 1,004 | 🌐 TypeScript | 📅 2026-02-08 Feature-rich ORM for modern Node.js and TypeScript | PostgreSQL, MySQL, MariaDB, SQLite, MS SQL Server, Snowflake, Oracle DB...
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,451 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-09 MongoDB object modeling designed to work in an asynchronous environment.
...
* [Kysely](https://github.com/kysely-org/kysely) ⭐ 13,433 | 🐛 153 | 🌐 TypeScript | 📅 2026-02-10 A type-safe typescript SQL query builder.
* [MikroORM](https://github.com/mikro-orm/mikro-orm) ⭐ 8,827 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-10 TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns.
...
* [ws](https://github.com/websockets/ws) ⭐ 22,655 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-09 Simple to use, blazing fast and thoroughly tested WebSocket client and server for Node.js.
...
* [FingerprintJS](https://github.com/fingerprintjs/fingerprintjs) ⭐ 26,453 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-07 - Makes a visitor identifier from a browser fingerprint that stays the same in incognito mode and when browser data is purged.
* [ky](https://github.com/sindresorhus/ky) ⭐ 16,323 | 🐛 32 | 🌐 TypeScript | 📅 2026-01-25 - Tiny and elegant HTTP client based on the browser Fetch API.
...
* [SurveyJS](https://github.com/surveyjs/survey-library) ⭐ 4,671 | 🐛 499 | 🌐 TypeScript | 📅 2026-02-09 - SurveyJS is a JavaScript Survey and Form Library. <https://surveyjs.io/>
...
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,397 | 🐛 3 | 📅 2026-01-18 - Possibly the best book written on modern JavaScript, completely readable online for free, or can be bought to support the author.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 436,352 | 🐛 69 | 📅 2026-01-28
* [MaximAbramchuck/awesome-interviews](https://github.com/MaximAbramchuck/awesome-interview-questions) ⚠️ Archived
* [enaqx/awesome-react](https://github.com/enaqx/awesome-react) ⭐ 71,924 | 🐛 15 | 📅 2026-01-14
* [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,207 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02
* [bolshchikov/js-must-watch](https://github.com/bolshchikov/js-must-watch) ⭐ 13,552 | 🐛 0 | 📅 2022-01-20
* [jnv/list](https://github.com/jnv/lists) ⭐ 10,949 | 🐛 7 | 📅 2025-05-20
* [davidsonfellipe/awesome-wpo](https://github.com/davidsonfellipe/awesome-wpo) ⭐ 8,803 | 🐛 5 | 🌐 JavaScript | 📅 2025-07-21
* [sotayamashita/awesome-css](https://github.com/sotayamashita/awesome-css) ⭐ 5,503 | 🐛 12 | 📅 2024-10-30
* [willianjusten/awesome-svg](https://github.com/willianjusten/awesome-svg) ⭐ 4,629 | 🐛 14 | 🌐 Shell | 📅 2026-01-06
...
* [apvarun/awesome-bun](https://github.com/apvarun/awesome-bun) ⭐ 3,450 | 🐛 53 | 📅 2025-07-20
* [emijrp/awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,091 | 🐛 16 | 📅 2024-07-31
